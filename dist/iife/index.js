var bundle = (function () {
    ...
    return ({
      ...
      return (async () => {
        ...
        try {
          ...
          return next((await actionWith(_objectSpread$1({}, failureType, {
        ...
        try {
          // Make the API call
          res = await doFetch(endpoint, _objectSpread$1({}, options, {
            method,
            body: body || undefined,
            credentials,
            headers: headers || {}
  ...
  var broker = function broker() {
    ...
    var body = isFileUpload ? options.body : JSON.stringify(options.body); // Constructs Redux API middleware compatible action

    return _defineProperty({}, RSAA$1, {
      endpoint: options.endpoint || "",
      method: options.method || "GET",
      types: options.types ? _types : [],
      headers: _objectSpread2({}, _typeof(options.headers) === "object" ? options.headers : {}),
      body: body
    });
  };
